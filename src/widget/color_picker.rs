use crate::widget::style::{Style, StyleFn};
use crate::widget::status::Status;
use crate::widget::{style, color_picker_overlay};
use crate::widget::color_picker_overlay::{
    ColorBarDragged, ColorPickerOverlay, ColorPickerOverlayButtons,
};
        ...
        + iced::widget::text::Catalog,
{
    ...
    pub fn style(
        mut self, 
        style: impl Fn(&Theme, Status) -> Style + 'a) -> Self
    where
        <Theme as style::Catalog>::Class<'a>: From<StyleFn<'a, Theme, Status>>,
    {
        self.class = (Box::new(style) as StyleFn<'a, Theme, Status>).into();
        self
    }
...
pub struct State {
    ...
    pub(crate) overlay_state: color_picker_overlay::State,
...
impl State {
    ...
    pub fn new(color: Color) -> Self {
        Self {
            overlay_state: color_picker_overlay::State::new(color),
